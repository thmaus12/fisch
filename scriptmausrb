...
InfoFish = Tap.General:AddSection('Info Fish') do
	...
	InfoFish:AddButton({
		Title = "Получить информацию Рыба в руке",
		Callback = function()
...
MiscPlayer = Tap.Player:AddSection('Misc Player') do
	...
	Toggle(MiscPlayer, "видеть ночью", "", "Remove Fog", function(Value)
		if Value then
	...
	MiscPlayer:AddButton({
		Title = "перезапуск на другой сервер",
		Description = "",
		Callback = function()
			AllFuncs.HopServer(true)
		end
...
Shoppy = Tap.Shop:AddSection('Shop All') do
	Toggle(Shoppy, "Телепорт к покупке", "", "Teleport To Buy")
...
-- Teleporting button for "Рослит Бэй"
Teleporting:AddButton({
    Title = "Roslit Bay",
    Callback = function()
...
-- Teleporting button for "Случайные острова"
Teleporting:AddButton({
...
-- Teleporting button for "Исполнительный штаб"
Teleporting:AddButton({
...
-- Teleporting button for "Зачарование комната"
Teleporting:AddButton({
...
-- Teleporting button for "Статуя Суверенитета"
Teleporting:AddButton({
...
-- Teleporting button for "Мушгроувское болото"
Teleporting:AddButton({
...
-- Teleporting button for "Снежный остров"
Teleporting:AddButton({
